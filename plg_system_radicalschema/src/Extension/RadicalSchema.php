...
class RadicalSchema extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onBeforeRender()
    {
            ...
            && $input->getCmd('component') === 'com_radicalschema')
        {
            ...
            $app->getDocument()->addScriptOptions('com_radicalschema.config', [
                'return_link' => base64_encode('index.php?option=com_config&view=component&component=com_radicalschema')
            ]);
        }
